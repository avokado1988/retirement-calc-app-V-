...
with tab3:
    ...
    with track_tabs[3]:
        cols = COMMON_COLS + ["הכנסת שכירות נטו", "הוצאת שכירות", "הוצאת תחזוקה", "תזרים נטו שכירות", "צבירה מסלול שכירות", "משיכה מתיק שכירות", "מס רווח הון — משיכה מתיק", "שווי נדלן מסלול 4"]
