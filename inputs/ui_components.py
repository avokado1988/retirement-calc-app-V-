...
# ==============================================================================
# 🎯 מילון ערכי ברירת המחדל החדשים והמעודכנים של המערכת
# ==============================================================================
DEFAULTS = {
    "start_age": 65.5,
    "retirement_age": 67.0,
    "check_age": 95.0,
    "desired_pension": 5306,             # עודכן ל-5,306 ₪
    "current_expenses": 11000,
    "expected_inflation": 0.023,
    "age_75_85_increase": 0.005,         # עודכן ל-0.5% (0.005)
    "age_85_plus_increase": 0.015,
    "one_time_expense": 80000,
    "one_time_frequency": 8,
    "caregiver_cost": 0,
    "national_insurance": 2587,
    "work_income": 0,
    "net_sale": 10000000,                # עודכן ל-10,000,000 ₪
    "existing_savings": 0,               # אופס - התזרים מבוסס כעת במלואו על המכירה
    "new_apartment_cost": 5800000,
    "property_appreciation": 0.023,
    "kids_help": 1000000,                # עודכן ל-1,000,000 ₪
    "emergency_fund": 300000,
    "annual_return": 0.055,              # 5.5% תשואה בשני המסלולים
    "management_fee": 0.006              # עודכן ל-0.6% (0.006) דמי ניהול בשני המסלולים
}
