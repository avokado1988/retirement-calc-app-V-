...
DEFAULTS = {
    "start_age": 65.5, "retirement_age": 67.0, "check_age": 87.0,
    "expected_inflation": 0.023, "current_expenses": 11000, "caregiver_cost": 3500,
    "one_time_expense": 80000, "one_time_frequency": 8, "work_income": 0,
    "desired_pension": 5000, "national_insurance": 2500, "annual_return": 0.05,
    "management_fee": 0.006, "net_sale": 10000000, "existing_savings": 440000,
    "new_apartment_cost": 5800000, "kids_help": 1000000, "emergency_fund": 300000,
    "property_appreciation": 0.023, "age_75_85_increase": 0.005, "age_85_plus_increase": 0.015
}
...
def format_percent(val_decimal):
    try: return f"{float(val_decimal) * 100:.1f}%"
    except: return val_decimal
