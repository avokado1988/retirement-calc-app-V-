...
def render_qa_section(results, user_inputs):
    ...
    # ----------------------------------------------------
    # שליפת משתנים נדרשים מהממשק לצורך החישובים בטבלאות
    # ----------------------------------------------------
    ...
    # ----------------------------------------------------
    # חילוץ נתונים מתוך היסטוריית הסימולציה
    # ----------------------------------------------------
    # חודש 0 (התחלה)
    ...
    # נתונים לגיל הנבדק (סוף הסימולציה או חודש היעד)
    ...
    data_check = {
        ...
        "גיל נבדק מסלול תיקון 190 - בגיל הנבדק": [
            ...
            "94.58",  # נקודת השוויון המדויקת מהמודל
            "85.2"
        ],
